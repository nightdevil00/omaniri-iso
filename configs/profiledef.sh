...
airootfs_image_tool_options=('-comp' 'xz' '-Xbcj' 'x86' '-b' '1M' '-Xdict-size' '1M' '-processors' '0')
...
file_permissions=(
  ...
  ["/var/cache/omaniri/mirror/offline/"]="0:0:775"
  ["/usr/local/bin/omaniri-upload-log"]="0:0:755"
)
